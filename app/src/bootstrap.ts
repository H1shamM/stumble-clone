...
export const DEFAULT_SEED_ASSETS: SeedAsset[] = [
  ...
  },
  {
    ...
    description:
      "Where is everybody? Tim Urban on the deafening cosmic silence.",
    source: "Wait But Why",
    category: "science",
    rating: 0,
    type: "article",
  ...
  },
  {
    ...
    description:
      "One button, one random and gloriously pointless corner of the web.",
  ...
  },
  {
    ...
    title: "Windows 93",
    description:
      "A surreal parody operating system you can actually play with.",
    source: "Windows93",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Wolfram Alpha",
    description:
      "A computational knowledge engine that answers, not just searches.",
    source: "WolframAlpha",
    category: "tech",
    rating: 0,
    type: "interactive",
  ...
  // === Funny (preview card) ===
  {
    ...
    description:
      "The Saturn V explained using only the 1,000 most common words.",
    source: "xkcd",
    category: "art",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    description:
      "Little Bobby Tables — the most famous SQL-injection joke ever.",
    source: "xkcd",
    category: "tech",
    rating: 0,
    type: "image",
  ...
  // --- Deep Dives (article) ---
  {
    ...
    description: "Paul Graham on what makers and painters have in common.",
    source: "Paul Graham",
    category: "tech",
    rating: 0,
    type: "article",
  ...
  },
  {
    ...
    title: "The Tail End",
    description:
      "A sobering, motivating look at how little time we have left with people.",
    source: "Wait But Why",
    category: "random",
    rating: 0,
    type: "article",
  ...
  },
  {
    ...
    description: "Kevin Kelly's hard-won, quotable life advice.",
    source: "Kevin Kelly",
    category: "random",
    rating: 0,
    type: "article",
  ...
  {
    id: "d10",
    url: "https://solar.lowtechmagazine.com/2015/10/how-to-build-a-low-tech-internet/",
    title: "How to Build a Low-Tech Internet",
    description: "Solar-powered, off-grid networks that already work.",
  ...
  },
  {
    ...
    title: "This Is Water",
    description: "DFW's commencement speech on attention and choice.",
  ...
  },
  {
    ...
    description: "Derek Sivers' filter for what to say yes to.",
    source: "Derek Sivers",
    category: "random",
    rating: 0,
    type: "article",
  ...
  },
  {
    ...
    description: "A caveman's guide to taming software complexity.",
    source: "Grug Brain",
    category: "tech",
    rating: 0,
    type: "article",
  ...
  },
  {
    ...
    description: "Why your name field is almost certainly wrong.",
    source: "Kalzumeus",
    category: "tech",
    rating: 0,
    type: "article",
  ...
  },
  {
    ...
    description: "All the ways writing a file to disk can betray you.",
    source: "Dan Luu",
    category: "tech",
    rating: 0,
    type: "article",
  ...
  },
  {
    ...
    description: "Richard Hamming on how to do work that matters.",
  ...
  },
  {
    ...
    description: "The hidden tax of async code, explained.",
    source: "Bob Nystrom",
    category: "tech",
    rating: 0,
    type: "article",
  ...
  },
  {
    ...
    title: "Radio Garden",
    description: "Spin the globe and tune into live radio anywhere.",
    source: "Radio Garden",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "WindowSwap",
    description: "Look out of someone else's window, somewhere in the world.",
    source: "WindowSwap",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "A Soft Murmur",
    description: "Mix your own ambient soundscape of rain, waves and wind.",
  ...
  },
  {
    ...
    description: "A live planetarium for the sky above you, right now.",
    source: "Stellarium",
    category: "science",
    rating: 0,
    type: "interactive",
  ...
  {
    id: "f10",
    url: "https://www.htwins.net/scale2/",
    title: "The Scale of the Universe",
    description: "Zoom from quantum foam to the cosmic web.",
  ...
  },
  {
    ...
    description: "A playable game-theory explainer on cooperation.",
    source: "Nicky Case",
    category: "science",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    description: "Jaw-dropping interactive explainers of how things work.",
    source: "Ciechanowski",
    category: "science",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Patatap",
    description: "A portable animation and sound kit — just start typing.",
    source: "Patatap",
    category: "art",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "This Is Sand",
    description: "Pour and paint with falling grains of sand.",
    source: "This Is Sand",
    category: "art",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Silk",
    description: "Draw shimmering, symmetrical generative art.",
    source: "Silk",
    category: "art",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Quick, Draw!",
    description: "Can a neural net guess your doodle in 20 seconds?",
    source: "Google AI",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  // --- Games (interactive) ---
  {
    ...
    title: "Wordle",
    description: "Six guesses, one five-letter word, once a day.",
    source: "NYT Games",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Lichess",
    description: "Free, no-ads online chess against the world.",
    source: "Lichess",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "GeoGuessr",
    description: "Dropped on a random street — guess where on Earth you are.",
    source: "GeoGuessr",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    url: "https://agar.io/",
    title: "Agar.io",
    description: "Eat cells, grow bigger, avoid being eaten.",
    source: "Agar.io",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Hextris",
    description: "A fast, hexagonal twist on falling-block puzzles.",
    source: "Hextris",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    description: "The original idle game — bake an absurd number of cookies.",
  ...
  },
  {
    ...
    title: "A Dark Room",
    description: "A minimalist text game that quietly becomes an epic.",
    source: "A Dark Room",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Sandspiel",
    description: "A falling-sand world of fire, water, plants and wind.",
    source: "Sandspiel",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Line Rider",
    description: "Draw a track and watch a sledder ride your lines.",
    source: "Line Rider",
    category: "art",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Flappy Bird",
    description: "Tap to flap. Rage to follow.",
    source: "Flappy Bird",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    url: "https://ztype.com/",
    title: "ZType",
    description: "Shoot down words by typing them — a space typing game.",
    source: "ZType",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "CrazyGames",
    description: "A huge library of instant browser games.",
    source: "CrazyGames",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  // --- Funny (image / interactive) ---
  {
    ...
    description: "Smart, dark, science-flavored comics.",
    source: "SMBC",
    category: "random",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    title: "The Oatmeal",
    description: "Long-form comics about life, cats, and grammar.",
    source: "The Oatmeal",
    category: "random",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    description: "Stick-figure comics with a mean streak.",
  ...
  },
  {
    ...
    description: "Gentle, absurd, surprisingly wise comics.",
  ...
  },
  {
    ...
    title: "The Onion",
    description: "America's finest (fake) news source.",
    source: "The Onion",
    category: "random",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    title: "Hacker Typer",
    description: "Mash the keyboard and feel like a movie hacker.",
    source: "Hacker Typer",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    description: "An endless, hypnotic fall through colored bands.",
    source: "Falling Falling",
    category: "art",
    rating: 0,
    type: "interactive",
    channel: "Funny",
  },
  {
    ...
    title: "Cat Bounce",
    description: "Bouncing cats. That's it. That's the site.",
    source: "Cat Bounce",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Endless Horse",
    description: "A horse with impossibly long legs. Keep scrolling.",
    source: "Endless Horse",
    category: "random",
    rating: 0,
    type: "interactive",
    channel: "Funny",
  },
  {
    ...
    description: "Click to reveal a hidden picture, dot by dot.",
    source: "Koalas to the Max",
    category: "random",
    rating: 0,
    type: "interactive",
    channel: "Funny",
  },
  {
    ...
    title: "The Zoomquilt",
    description: "An infinitely zooming collaborative painting.",
    source: "Zoomquilt",
    category: "art",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    description: "Wiggle your mouse. Maybe don't do it too hard.",
  ...
  // --- Gadgets & Tools (interactive) ---
  {
    ...
    title: "Squoosh",
    description: "Compress and compare images right in the browser.",
    source: "Squoosh",
    category: "tech",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "remove.bg",
    description: "Erase any photo's background in one click.",
    source: "remove.bg",
    category: "tech",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "tldraw",
    description: "A delightful infinite collaborative whiteboard.",
    source: "tldraw",
    category: "tech",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "regex101",
    description: "Build and debug regular expressions live.",
    source: "regex101",
    category: "tech",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "JSON Crack",
    description: "Turn any JSON into an explorable node graph.",
    source: "JSON Crack",
    category: "tech",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Carbon",
    description: "Make beautiful images of your source code.",
    source: "Carbon",
    category: "tech",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    description: "See the assembly your code compiles to, instantly.",
  ...
  },
  {
    ...
    url: "https://oeis.org/",
    title: "OEIS",
    description: "The encyclopedia of integer sequences.",
    source: "OEIS",
    category: "science",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    description: "Plot functions and play with math, beautifully.",
    source: "Desmos",
    category: "science",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "CodePen",
    description: "A playground for front-end code experiments.",
    source: "CodePen",
    category: "tech",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Coolors",
    description: "Generate and lock in beautiful color palettes fast.",
    source: "Coolors",
    category: "art",
    rating: 0,
    type: "interactive",
  ...
  // --- Art (image) ---
  {
    ...
    title: "WikiArt",
    description: "A vast visual encyclopedia of fine art.",
    source: "WikiArt",
    category: "art",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    description: "Explore the world's museums from your couch.",
  ...
  },
  {
    ...
    description: "Half a million open-access artworks.",
    source: "The Met",
    category: "art",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    title: "Rijksstudio",
    description: "Dutch masters in stunning open-access detail.",
    source: "Rijksmuseum",
    category: "art",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    description: "A new AI-generated face every time you reload.",
    source: "TPDNE",
    category: "tech",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    title: "Archillect",
    description: "An AI that discovers and curates striking images.",
    source: "Archillect",
    category: "art",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    title: "Behance",
    description: "Showcase galleries from working creatives.",
    source: "Behance",
    category: "art",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    title: "Dribbble",
    description: "A firehose of polished design shots.",
    source: "Dribbble",
    category: "art",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    description: "Decades of space imagery, free to explore.",
    source: "NASA",
    category: "science",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    description: "The universe in breathtaking high resolution.",
    source: "ESA/Hubble",
    category: "science",
    rating: 0,
    type: "image",
  ...
  },
  {
    ...
    description: "Scanned art from the golden age of book printing.",
  ...
  },
  {
    ...
    title: "Europeana",
    description:
      "Millions of artworks and artifacts from Europe's collections.",
    source: "Europeana",
    category: "art",
    rating: 0,
    type: "image",
  ...
  // --- Indie & Classic Web (interactive / image) ---
  {
    ...
    title: "Hacker News",
    description: "The tech world's front page of links and debate.",
    source: "Hacker News",
    category: "tech",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    description: "A search engine that favors the small, text-first web.",
    source: "Marginalia",
    category: "tech",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Neocities",
    description: "The revival of creative, hand-made personal sites.",
    source: "Neocities",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Gossip's Web",
    description: "A hand-curated directory of the indie web.",
    source: "Gossip's Web",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    title: "Bear Blog Discovery",
    description: "Fresh posts from a fast, minimal blogging community.",
    source: "Bear Blog",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    description: "A love letter collage of the old GeoCities web.",
  ...
  },
  {
    ...
    description: "Two artists living and building software off-grid on a boat.",
  ...
  },
  {
    ...
    title: "The Yesterweb",
    description: "A community reclaiming a more human internet.",
    source: "Yesterweb",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    description: "Every possible page of text that ever could be written.",
    source: "Library of Babel",
    category: "random",
    rating: 0,
    type: "interactive",
    channel: "Indie & Classic Web",
  },
  {
    ...
    description: "A playable museum of the web, from 1977 to today.",
    source: "neal.fun",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  {
    id: "v5",
    url: "https://www.youtube.com/embed/s86-Z-CbaHA",
    title: "The Banach–Tarski Paradox",
    description:
      "Vsauce on cutting a ball into pieces and reassembling two identical balls.",
    source: "Vsauce",
    category: "science",
    rating: 0,
    type: "video",
  ...
  },
  {
    ...
    description:
      "3Blue1Brown's beautifully visual introduction to deep learning.",
    source: "3Blue1Brown",
    category: "tech",
    rating: 0,
    type: "video",
  ...
  {
    id: "v7",
    url: "https://www.youtube.com/embed/TRL7o2kPqw0",
    title: "The Most Radioactive Places on Earth",
    description: "Veritasium travels the globe with a Geiger counter.",
    source: "Veritasium",
    category: "science",
    rating: 0,
    type: "video",
  ...
  },
  {
    ...
    title: "Pale Blue Dot",
    description: "Carl Sagan's reflection on the one home we've ever known.",
    source: "Carl Sagan",
    category: "science",
    rating: 0,
    type: "video",
  ...
  // Indie & Classic Web (homepages render as preview cards, #172)
  {
    ...
    title: "JS Paint",
    description: "A pixel-perfect remake of MS Paint, right in the browser.",
    source: "JS Paint",
    category: "tech",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    description: "The original Space Jam website, preserved exactly as it was.",
    source: "Space Jam",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  },
  {
    ...
    url: "https://zombo.com/",
    title: "Zombo.com",
    description: "The only limit is yourself. A monument to the early web.",
    source: "Zombo",
    category: "random",
    rating: 0,
    type: "interactive",
  ...
  // Science & Space (article = deep reader-extractable permalink; image/interactive render as cards)
  {
    ...
    title: "HubbleSite",
    description: "The official gallery of Hubble Space Telescope imagery.",
    source: "HubbleSite",
    category: "science",
    rating: 0,
    type: "image",
    channel: "Science & Space",
  },
  {
    id: "sci2",
    ...
    description: "A deep, readable feature on the quantum vacuum.",
  ...
  },
  {
    ...
    description: "An interactive 3D model of the solar system and night sky.",
